...
\begin{figure}[htb]
  ...
  \begin{center}
   \includegraphics[width=120mm]{optics_microscopy/schematics_BS_T2.eps}
  \end{center}
  ...
  \begin{minipage}{\hsize}
  \begin{center}
   \includegraphics[width=110mm]{optics_microscopy/schematics_BS_R.eps}
  \end{center}
  ...
  \label{fig:schematics_BS_R}
   \end{minipage}
     \begin{minipage}{\hsize}
  \begin{center}
   \includegraphics[width=120mm]{optics_microscopy/schematics_BS_T2R.eps}
  \end{center}
...
\begin{figure}[htb]
    \begin{minipage}{\hsize}
  \begin{center}
   \includegraphics[width=0.7\hsize]{optics_microscopy/BS_T2.eps}
  \end{center}
  ...
  \label{fig:BS_T2}
   \end{minipage}
    \begin{minipage}{\hsize}
  \begin{center}
   \includegraphics[width=0.7\hsize]{optics_microscopy/BS_R.eps}
  \end{center}
  ...
  \label{fig:BS_R}
   \end{minipage}
    \begin{minipage}{\hsize}
  \begin{center}
   \includegraphics[width=0.7\hsize]{optics_microscopy/BS_T2R.eps}
  \end{center}
