...
plot(data.frame(data[3],data[6]),xlim=XLIM,ylim=YLIM,xlab="Temperature(K)",ylab="Resistance (Ohm)",log="y",type="o",col="violet",cex=0.5)
par(new=TRUE) #
data <- read.csv("181213_sample6_ch1-2_afterpulse2_005.csv",header=F)
plot(data.frame(data[3],data[6]),xlim=XLIM,ylim=YLIM,xlab="",ylab="",log="y",type="o",col="black",cex=0.5)
par(new=TRUE) #
data <- read.csv("181228_SnGe6_ch1_001.csv",header=F)
