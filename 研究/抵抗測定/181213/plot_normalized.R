...
plot(data.frame(data[3],1000*data[6]),xlim=XLIM,ylim=YLIM,xlab="Temperature(K)",expression(paste("Resistance(m",Omega,")")),type="p",col="red",cex=4,cex.lab=4,axes=FALSE)
